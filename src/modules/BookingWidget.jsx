...
const T = {
  ES: {
    ...
    descs: {
      ...
      "Exclusive Pass":    "Experiencia premium para grupos: zona privada, open bar y atención personalizada.",
      "Atolon Experience": "El máximo lujo: traslado en yate privado, chef a bordo y acceso VIP a todas las áreas.",
      "After Island":      "La fiesta no para: disfruta la isla de noche con música, coctelería y vistas únicas.",
    },
  ...
  EN: {
    ...
    descs: {
      ...
      "Exclusive Pass":    "Premium group experience: private area, open bar and personalized service.",
      "Atolon Experience": "Ultimate luxury: private yacht transfer, on-board chef and VIP access to all areas.",
      "After Island":      "The party never stops: enjoy the island at night with music, cocktails and unique views.",
    },
  ...
  PT: {
    ...
    descs: {
      ...
      "Exclusive Pass":    "Experiência premium em grupo: área privativa, open bar e atendimento personalizado.",
      "Atolon Experience": "O máximo luxo: transfer em iate privado, chef a bordo e acesso VIP a todas as áreas.",
      "After Island":      "A festa não para: aproveite a ilha à noite com música, drinks e vistas únicas.",
    },
