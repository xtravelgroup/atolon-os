...
const HotelIntegraciones = lazy(() => import("./modules/HotelIntegraciones"));
...
const Almacenes = lazy(() => import("./modules/Almacenes"));
...
const MODULE_MAP = {
  ...
  hotel_integraciones: <HotelIntegraciones />,
...
export default function App() {
  ...
  useEffect(() => {
    const handler = (e) => {
      const { modulo, reservaId, clienteId, aliadoId, conversationId } = e.detail || {};
      ...
      if (conversationId) window.__openConversationId = conversationId;
      if (modulo) {
